...
import sys
import argparse
from player.text_processing import french_word_functions as fwf
...
def main(raw_args):
  ...
  parser.add_argument('-m', '--metadata_path', type=str, required=True, help='Path to the tab-delimited tsv file with metadata')
